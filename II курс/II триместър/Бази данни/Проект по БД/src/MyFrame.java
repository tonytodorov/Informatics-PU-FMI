...
public class MyFrame extends JFrame{
	...
	JLabel buildingL = new JLabel("Име на сграда:");
	JLabel addressL  = new JLabel("Адрес:");
	JLabel heightL 	 = new JLabel("Височина:");
	...
	JLabel roomSizeL 	   = new JLabel("Размер на стая:");
	JLabel roomNameL 	   = new JLabel("Тип стая:");
	...
	JButton addBt1 	   = new JButton("Добавяне");
	JButton editBt1    = new JButton("Редактиране");
	JButton deleteBt1  = new JButton("Изтриване");
	JButton searchBt1  = new JButton("Търсене по име");
    JButton refreshBt1 = new JButton("Обнови");
	
    
	
	JLabel buildingNL 	  = new JLabel("Име на сграда:");
	JLabel typeRoomL 	  = new JLabel("Тип стая:");
	
	JTextField priceTF    = new JTextField();

	JButton addBt2 	  = new JButton("Добавяне");
	JButton editBt2   = new JButton("Редактиране");
	JButton deleteBt2 = new JButton("Изтриване");
	...
	JLabel queryBuildingL 	= new JLabel("Име на сграда:");
    JLabel queryTypeRoomL 	= new JLabel("Тип стая:");
    
 
	JTextField queryBuildingTF 	= new JTextField();
	JTextField queryTypeRoomTF 	= new JTextField();
    
    JButton showBt 				= new JButton("Покажи");
	...
	public MyFrame() {
	    ...
	    tabs.add("Справка по име и тип", p4);
	    p4.setLayout(null);
